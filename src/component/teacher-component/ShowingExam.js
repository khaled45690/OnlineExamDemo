            ...
            <SharedData.Consumer>{(context) => {
                ...
                return (<div>
                    ...
                    {Object.keys(Exam).map((key1, i) => {
                        ...
                        let Var1 = Exam[key1];
                        return (<div>  <h2 class="head " style={{ textAlign: "right" , color:"blue" }}><b>السؤال {this.state.question_names[i]}:-</b></h2>
                                                                       ...
                                                                       // this code will run if there is multiple answers like complete
                                                                        return (<div>
                                                                            ...
                                                                            {Object.keys(Answer).map((key, i) => {
                                                                                ...
                                                                                return (<div>
                                                                                    <input style={{ width: "50px;", marginTop: "20px" }} type="text" class="form-control complete-input " placeholder="ادخل الاجابة الصحيح" />
                                                                                </div>)
                                                                        ...
                                                                        return (<div>
                                                                            ...
                                                                            <div style={{display:"flex"}}>
                                                                                <section>
                                                                                    <input type="radio" style={{marginTop:"10px"}} name={"name " + key1 + " " + key2 + " " + key3 } value="true"/>
                                                                                    <b style={{marginRight:"10px"}}>صح</b>
                                                                                </section>
                                                                                <section style={{marginRight:"30px"}}>
                                                                                    <input type="radio" style={{marginTop:"10px"}} name={"name " + key1 + " " + key2 + " " + key3} value="false"/>
